...
final_number_of_mutants = sim.clones_array[1, sim.size_idx]
VAF = final_number_of_mutants / np.sum(sim.clones_array[:, sim.size_idx])
print(VAF)


# TODO: Add calculation of total mutant takeover
