...
np.full(100, SELECTIVE_FITNESS)  # The next 100 clones given fitness 1.3
            ])
    ),
...
plt.savefig(os.path.join(docs_dir, '9900v100_1.3_muller_comparison_wf.png'), dpi=150, bbox_inches='tight')
...
plt.savefig(os.path.join(docs_dir, '9900v100_1.3_size_comparison_wf.png'), dpi=150, bbox_inches='tight')
...
plt.tight_layout
plt.savefig(os.path.join(docs_dir, '9900v100_1.3_survival_comparison_wf.png'), dpi=150, bbox_inches='tight')
