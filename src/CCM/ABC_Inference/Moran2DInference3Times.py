...
# My code using Moran2D algorithm to run ABC simulations. 3 timepoints. 
...
# This is what pyabc actually calls when it wants to test parameters
    try: 
        initial_grid, fitness_array, label_array = get_grid(parameters['fitness'], parameters['induction'], SHAPE_OF_GRID, CELLS)
...
# very wide initial berth. RV is imported from pyabc.)
    ...
    db_path_first3 = ("sqlite:///" + "Moran2DTP53First3"+'_pyabc.db')
