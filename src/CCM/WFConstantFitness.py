...
plt.title("WF Competition Between One Wild-Type Cell and 99 Fitter Cells of Constant Fitness")
plt.xlabel("Time")
...
plt.savefig(os.path.join(docs_dir, 'muller_wf_constant100clones.png'), dpi=150, bbox_inches='tight')


sim.plot_surviving_clones_for_non_mutation()
plt.title("Constant Fitness: Surviving Clones for Non-Mutation Case")
plt.savefig(os.path.join(docs_dir, 'survival_wf_constant100clones.png'), dpi=150, bbox_inches='tight')
...
plt.savefig(os.path.join(docs_dir, 'meanclonesize_wf_constant100clones.png'), dpi=150, bbox_inches='tight')
