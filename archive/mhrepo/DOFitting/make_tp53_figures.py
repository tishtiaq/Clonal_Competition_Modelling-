...
# This is the code Claude wrote to plot TP53 figures and show their bad fit
...
fig.suptitle("Same model, but showing different time windows: result of incompatible fitted parameters\n"
             "(95% confidence intervals from the completed ABC-SMC posteriors which do not overlap)",
             fontsize=11, y=1.03)
fig.tight_layout()
fig.savefig("fig1_parameter_instability.png", dpi=200, bbox_inches='tight')
# plt.close(fig)
...
fig.tight_layout()
fig.savefig("fig2_predicted_vs_observed.png", dpi=200, bbox_inches='tight')
# plt.close(fig)
...
fig.tight_layout()
fig.savefig("fig3_growth_rate_instability.png", dpi=200, bbox_inches='tight')
# plt.close(fig)
