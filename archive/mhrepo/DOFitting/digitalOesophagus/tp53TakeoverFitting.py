...
# Michael's code, uses all the 6 time points

from pyabc import (ABCSMC, RV, Distribution, PNormDistance)
# pyabc is built for approximate bayesian computation: technique for 
# estimating unknown parameters when you can simulate data but don't
# have a mathematial likelihood function
...
# Another tracker of how far simulation is from real results
